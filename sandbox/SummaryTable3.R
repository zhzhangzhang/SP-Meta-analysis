# import the data
library(haven)
sp_provider_df <- read_dta('/Users/songshuyi/Documents/GitHub/SP-Meta-analysis/data-raw/provider_sp_alldata_clean.dta')
...
var %>% tbl_summary( by = sp_clinics_level,
                     ...
                     ) %>% modify_caption("**Table 3. Physician characteristics**")
